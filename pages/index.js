...
export default function Home() {
  ...
  return (
    <main className="bg-gray-900 text-white min-h-screen px-6 py-8">
      ...
      <h1 className="text-3xl font-bold text-white mb-6">태양광 수익성 계산기</h1>
      ...
      <footer className="mt-10 text-xs text-gray-400 text-center border-t border-gray-700 pt-4 leading-relaxed">
